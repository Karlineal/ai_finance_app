...
import com.aifinance.core.database.entity.SavingsGoalEntity // 💡 新增导入
...
@Database(
    entities = [
        ...
        SavingsGoalEntity::class, // 💡 1. 注册新表
    ],
    version = 6, // 💡 2. 数据库版本升级到 6
    exportSchema = true,
)
...
abstract class AiFinanceDatabase : RoomDatabase() {
    ...
    abstract fun savingsGoalDao(): SavingsGoalDao // 💡 3. 注册新 DAO
}