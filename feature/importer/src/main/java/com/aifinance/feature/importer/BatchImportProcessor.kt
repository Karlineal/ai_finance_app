...
object BatchImportRuleCatalog {
    ...
    val defaultExpenseRules = listOf(
        ...
        CategoryRule(CategoryCatalog.Ids.ExpenseHousing, 0.9f, "\u623f\u79df", "\u7269\u4e1a", "\u6c34\u7535", "\u71c3\u6c14", "\u5bbd\u5e26"),
        CategoryRule(CategoryCatalog.Ids.ExpenseCommunication, 0.86f, "\u8bdd\u8d39", "\u6d41\u91cf", "\u79fb\u52a8", "\u8054\u901a", "\u7535\u4fe1"),
        CategoryRule(CategoryCatalog.Ids.ExpenseMedical, 0.9f, "\u533b\u9662", "\u836f", "\u95e8\u8bca", "\u4f53\u68c0", "\u533b\u7597"),
